...
调用指定命令：调用 `mcp_wecom_meeting_<tool_name> '<json_params>'`
...
调用 `mcp_wecom_meeting_cancel_meeting '{"meetingid": "<会议id>"}'`
...
调用 `mcp_wecom_meeting_set_invite_meeting_members '{"meetingid": "<会议id>", "invitees": [{"userid": "lisi"}, {"userid": "wangwu"}]}'`
...
调用 `mcp_wecom_meeting_cancel_meeting '{"meetingid": "<target_meetingid>"}'`
...
调用 `mcp_wecom_meeting_set_invite_meeting_members '{"meetingid": "<target_meetingid>", "invitees": [{"userid": "zhangsan"}, {"userid": "lisi"}, {"userid": "wangwu"}]}'`
