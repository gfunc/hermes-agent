...
使用 `mcp_wecom_*` tool 调用 `mcp_wecom_msg_get_msg_chat_list '{"begin_time": "2026-03-11 00:00:00", "end_time": "2026-03-17 23:59:59"}'`

分页请求：

使用 `mcp_wecom_*` tool 调用 `mcp_wecom_msg_get_msg_chat_list '{"begin_time": "2026-03-11 00:00:00", "end_time": "2026-03-17 23:59:59", "cursor": "NEXT_CURSOR"}'`
