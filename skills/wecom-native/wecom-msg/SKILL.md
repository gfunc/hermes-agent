...
调用 `mcp_wecom_msg_get_msg_chat_list '{"begin_time": "2026-03-11 00:00:00", "end_time": "2026-03-17 23:59:59"}'`

按时间范围查询有消息的会话列表，支持分页。参见 [API 详情](references/api-get-msg-chat-list.md)。

### get_messages — 拉取会话消息

调用 `mcp_wecom_msg_get_messages '{"chat_type": 1, "chatid": "zhangsan", "begin_time": "2026-03-17 09:00:00", "end_time": "2026-03-17 18:00:00"}'`
...
调用 `mcp_wecom_msg_get_msg_media '{"media_id": "MEDIAID_xxxxxx"}'`
...
调用 `mcp_wecom_msg_send_message '{"chat_type": 1, "chatid": "zhangsan", "msgtype": "text", "text": {"content": "hello world"}}'`
...
### userid转username
**流程**：
1. 调用 `mcp_wecom_contact_get_userlist` 获取用户列表
